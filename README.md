...
`version` が `3.7.8-python3.14`、`revision` が空の場合、workflow は次の名前を使います。

| 種類 | 名前 |
| --- | --- |
| Worker Image Release Tag | `3.7.8-python3.14` |
| Base Worker Image | `mizucopo/prefect-worker:3.7.8-python3.14-base` |
| Process Worker Image | `mizucopo/prefect-worker:3.7.8-python3.14-process` |
...
prefect-process-worker:
  image: "mizucopo/prefect-worker:3.7.8-python3.14-process"
